...
ventana = tk.Tk()
ventana.geometry('650x400+900+400')
ventana.title('Componentes')
ventana.iconbitmap('icono.ico')

def crear_componentes_tabulador1(tabulador):
    # Agregar un etiqueta y un componente de entrada 
...
def crear_componentes_tabulador5(tabulador):
    ...
    def ejecutar_barra():
        ...
        for valor in range(101):
            # Mandamos a esperar un poco antes de continuar con la ejecuci+on de la barra 
            sleep(0.05)
            # Incrementamos nuestra barra de progreso 
            barra_progreso['value'] = valor 
            # Actualizamos la barra de progresos 
    ...
    # Botones para controlar los eventoos de una barra de progreso 
...
def crear_tabs():
    ...
    # Creamos los componentes del siguiente tabuladro 
    crear_componentes_tabulador2(tabulador2)
    # Crear un tercer tabuladro 
    ...
    # Creamos los componentesd el cuarto tabulador 
